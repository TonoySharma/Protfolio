...
const AboutSectionPage = () => {
  ...
  return (
    ...
    <section className="bg-[#05010d] py-20 md:py-40 px-4 sm:px-6 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              ...
              <p className="text-gray-400 text-xs md:text-sm">Year of <br /> Experience</p>
            </motion.div>
          </motion.div>
          ...
          >
            <p className="text-purple-500 font-mono tracking-widest uppercase text-xs md:text-sm mb-4">Who I Am</p>
            ...
            <div className="grid grid-cols-2 gap-4 md:gap-8 mb-10">
              {stats.map((item, index) => (
                <div key={index} className="border-l-2 border-purple-500/30 pl-4 md:pl-6">
                  ...
                  <p className="text-gray-500 text-[10px] md:text-sm uppercase tracking-wider">{item.label}</p>
                </div>
              ))}
            </div>
          </motion.div>
